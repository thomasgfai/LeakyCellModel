function F = my_F_deriv_3D_fcc(v,RR,NN)
% define free volume
a_vec = (sqrt(2)*v).^(1/3);
...
%        F(i) = Nt/4*(da_dv*a.^2/(2*sqrt(2))...
%             +6*ddouble_int*dihedral_angle_t-4/2*dtriple_int)...
%             +No/6*(da_dv*a.^2/sqrt(2)...
%             +12*ddouble_int*dihedral_angle_o...
%             +3*dlong_double_int-12*dsquare_triple_int-8/2*dtriple_int+3*dquad_int)...
%             -Nt*3*ddouble_int*dihedral_angle_t ...
%             -No*4*ddouble_int*dihedral_angle_o ...
%             -No*dlong_double_int ...
%             +Nt*3/2*dtriple_int ...
%             +No*4/2*dtriple_int ...
%             +No*6*dsquare_triple_int ...
%             -No*2*dquad_int;
...
%             +2*ddouble_int*dihedral_angle_o)...
%             -4*dtriple_int;
%         tmp = No/6*(da_dv*sqrt(2)*a.^2 ...
%             +12*ddouble_int*dihedral_angle_o-8/2*dtriple_int);
%         F(i) = F(i)-5*tmp;
        
        %         F(i) = Nt/4*(da_dv*a.^2/(2*sqrt(2)) ...
%             +6*ddouble_int*dihedral_angle_t-4/2*dtriple_int) ...
%             +No/6*(da_dv*sqrt(2)*a.^2 ...
%             +12*ddouble_int*dihedral_angle_o-8/2*dtriple_int);
%         F(i) = No/6*(da_dv*sqrt(2)*a.^2 ...
%             +12*ddouble_int*dihedral_angle_o-8/2*dtriple_int);
%         
%         F(i) = Nt/4*(da_dv*a.^2/(2*sqrt(2)) ...
%             +6*ddouble_int*dihedral_angle_t-4/2*dtriple_int) ...
...
%             +No/6*(da_dv*sqrt(2)*a.^2 ...
%             +8*ddouble_int*dihedral_angle_o) ...
%              +(NN-1)*(Nt/4*(da_dv*a.^2/(2*sqrt(2)) ...
%             +6*ddouble_int*dihedral_angle_t) ...
%             +No/6*(da_dv*sqrt(2)*a.^2 ...
%             +12*ddouble_int*dihedral_angle_o));
...
%         F(i) = 16/3+3*Nt*ddouble_int*dihedral_angle_t ...
%             +No*8*ddouble_int*dihedral_angle_o;

%         F(i) = (NN+(NN-1)*12/2*ddouble_int-12/2*ddouble_int);
%         F(i) = NN;
...
% a_end = a2;
% F_start = NN;
% F_end = Nt*(da_dv*a.^2/(2*sqrt(2)) ...
%             +3*ddouble_int*dihedral_angle_t) ...
%             +No*(da_dv*sqrt(2)*a.^2 ...
%             +8*ddouble_int*dihedral_angle_o);
%         
% F(i) = F_start+(F_end-F_start)* ...
%     (a-a_start)/(a_end-a_start)+da_dv*(F_end-F_start)/(a_end-a_start);
    else
        da_dv = da_dv_vec(i);
        Nt = 8; No = 6;
